...
class RandomController extends Controller
{
    ...
    public function store(RandomCreateRequest $request)
    {
        ...
        return $this->success(['data' => $random], trans('messages.randoms.storeSuccess'), ['code' => Response::HTTP_CREATED]);
    }
    ...
    public function getChairsByVote($voteId)
    {
        ...
        return $this->success($result, trans('messages.randoms.success'), ['isContainByDataString' => true]);
    }
