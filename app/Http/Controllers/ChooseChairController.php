...
class ChooseChairController extends Controller
{
    ...
    public function ticketOfUser(Request $request)
    {
        ...
        return $this->success($ticket, trans('messages.chooseChairs.success'), ['isContainByDataString' => true]);
    }
    ...
    public function randChairs(Request $request)
    {
        ...
        return $this->success($random, trans('messages.chooseChairs.success'), ['isContainByDataString' => true]);
    }
